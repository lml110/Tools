...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _helper = __webpack_require__(/*! ./helper */ \"./src/helper.js\");\n\nvar _helper2 = _interopRequireDefault(_helper);\n\nvar _dates = __webpack_require__(/*! ./dates */ \"./src/dates.js\");\n\nvar _dates2 = _interopRequireDefault(_dates);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar _float = _helper2.default._float;\nvar _formatDate = _dates2.default._formatDate;\n\n\nvar fileToDataURL = function fileToDataURL(file, callback) {\n    var reader = new FileReader();\n    reader.onload = function (e) {\n        return callback && callback(e.target.result);\n    };\n    reader.readAsDataURL(file);\n};\n\nvar dataURLtoBlob = function dataURLtoBlob() {\n    var arr = dataurl.split(','),\n        mime = arr[0].match(/:(.*?);/)[1],\n        bstr = atob(arr[1]),\n        n = bstr.length,\n        u8arr = new Uint8Array(n);\n    while (n--) {\n        u8arr[n] = bstr.charCodeAt(n);\n    };\n    return new Blob([u8arr], { type: mime });\n};\n\n//获取canvas渲染的像素倍数\nvar getPixelRatio = function getPixelRatio(context) {\n    var backingStore = context.backingStorePixelRatio || context.webkitBackingStorePixelRatio || context.mozBackingStorePixelRatio || context.msBackingStorePixelRatio || context.oBackingStorePixelRatio || context.backingStorePixelRatio || 1;\n    return (window.devicePixelRatio || 1) / backingStore;\n};\n\n/**\r\n * @class  获取图片元素信息\r\n * @author liumouliang 2019-01-18\r\n *\r\n * @param  {[type]}    file\r\n * @param  {Function}  callback\r\n * @return {[type]}\r\n */\nvar getImgeInfo = function getImgeInfo(file, callback) {\n    //file.files[0]\n    var resObj = {};\n    return fileToDataURL(file, function (base64) {\n        var image = new Image();\n        image.onload = function () {\n            resObj = {\n                base64: base64,\n                width: image.width,\n                height: image.height,\n                type: file.type, //image/png\n                name: file.name,\n                date: _formatDate(file.lastModifiedDate, 'yyyy-MM-DD hh:mm:ss'),\n                size: file.size, //_B\n                size_KB: _float(file.size / 1024, 2),\n                size_MB: _float(file.size / 1024 / 1024, 2)\n            };\n            return callback && callback(resObj);\n        };\n        image.src = base64;\n    });\n};\n\nexports.default = {\n    fileToDataURL: fileToDataURL,\n    dataURLtoBlob: dataURLtoBlob,\n    getImgeInfo: getImgeInfo //获取图片元素信息\n};\n//MakePic\n\n//# sourceURL=webpack:///./src/MakePic.js?");
